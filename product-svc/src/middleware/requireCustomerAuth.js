...
import { getCustomerAccessTokenSecret, verifyCustomerAccessToken } from "../customer-auth/customer-auth.shared.js";
...
export async function requireCustomerAuth(req, res, next) {
  try {
    ...
    if (!getCustomerAccessTokenSecret()) return misconfigured(res);

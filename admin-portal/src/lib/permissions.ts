...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { id: "categories", href: "/admin/categories", label: ADMIN_UI_STRINGS.menu.categories, anyOf: ["category:read", "category:write", "category:delete"] },
  { id: "products", href: "/admin/products", label: ADMIN_UI_STRINGS.menu.products, anyOf: ["product:read", "product:write", "product:delete", "product:publish"] },
  ...
  { id: "inventory", href: "/admin/inventory", label: ADMIN_UI_STRINGS.menu.inventory, anyOf: ["inventory:read", "inventory:write"] },

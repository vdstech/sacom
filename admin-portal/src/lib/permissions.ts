...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { id: "ordersDashboard", href: "/admin/orders/dashboard", label: ADMIN_UI_STRINGS.menu.ordersDashboard, anyOf: ["order:read"] },
  ...
  { id: "productReviews", href: "/admin/products/reviews", label: ADMIN_UI_STRINGS.menu.productReviews, anyOf: ["review:read", "review:moderate"] },
  ...
  { id: "audit", href: "/admin/audit", label: ADMIN_UI_STRINGS.menu.audit, anyOf: ["audit:read"] },
];

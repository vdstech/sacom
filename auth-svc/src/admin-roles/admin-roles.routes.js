...
import { createRoleValidator, updateRoleValidator } from "./admin-roles.validation.js";
...
r.put("/:id", requireAuth, updateRoleValidator, requiresPermission("role:update"), handleValidation, controller.updateRole);
